{applications,approximation,discrete,namd,performance,programming}.texIn this project you will combine some of the theory and practical
...
tutorial~\ref{tut:petsc}. In particular, use the \n{MatMult} routine
