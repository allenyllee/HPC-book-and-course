...
\begin{figure}[ht]
  \hbox{$\vcenter{\hbox{\includegraphics[scale=.1]{graph1}}}$
    $
    \begin{cases}
      V=\{1,2,3,4,5,6\}\\
...
\begin{figure}[ht]
  \hbox{$\vcenter{\hbox{\includegraphics[scale=.1]{graph2a}}}$
    A graph}
  \hbox{$\vcenter{\hbox{\includegraphics[scale=.1]{graph2b}}}$
    Two paths from 1 to 6; $\langle 1,4,6\rangle$ is the shorter}
  \hbox{$\vcenter{\hbox{\includegraphics[scale=.1]{graph2c}}}$
