...
are terminating, are repeating. See section~\ref{sec:bcd} for why some
people care about this and what was done about it.
...
influences the result. For instance, consider computing the sum of a
large number~$N$ of terms. With $P$~processors at our disposition, we
can let each compute $N/P$ terms, and combine the partial results. We
immediately see that for no two values of~$P$ will the results be
identical. This means that reproducibility of results in a parallel
context is elusive.
