...
\Level 0 {Shortest path algorithms}
...
This algorithm is correct since, for a given node~$u$, after $k$ steps of the outer iteration
...
\Level 0 {Floyd-Warshall all-pairs shortest path}

The \indexterm{Floyd-Warshall algorithm} is an example of an all-pairs
...
\indexterm{Prim's algorithm}, a minimal variant of \indexterm{Dijkstra's shortest path algorithm},
