...
Such data-independent sorting algorithms are sometimes
called \indextermbus{sorting}{networks}. They can be considered
...
the total \indextermbus{sequential complexity of}{bitonic sorting}~$(\log_2N)^2$.
\index{bitonic sorting|)}
