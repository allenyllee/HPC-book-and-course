...
The following example\footnote{This is strictly Unix-centric and will
  not work on Windows.} uses the \emph{pthreads} library to spawn
...
executes first, is known as a \indexterm{race condition}.
...
\begin{figure}
\includegraphics{graphics-public/hyperthread_image1}
