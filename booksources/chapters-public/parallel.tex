...
We assume for simplicity that each task takes time~$\equiv1$.
We define \indextermsub{average}{parallelism} as $T_1/T_\infty$.
...
\begin{wrapfigure}{r}{3in}
  \includegraphics[scale=.081]{graphics-public/hypercubenumber}
...
\def\graycodepicture{
\begin{wrapfigure}{r}{3in}
  \includegraphics[scale=.081]{graphics-public/hypercubegraynumber}
