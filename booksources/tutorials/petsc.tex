...
%% from\\
%% \url{http://tinyurl.com/ISTC-petsc-tutorial}.
While doing these
...
%\listing{init.c}{tutorials/petsc/exercises/cexercises/init.c}
...
\listing{vec.c}{tutorials/petsc/exercises/cexercises/vec.c}
...
\listing{mat.c}{tutorials/petsc/exercises/cexercises/mat.c}
