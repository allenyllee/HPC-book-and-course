...
The \indextermunix{ls} command gives you a listing of files that are in your
present location. 
...
Three more useful commands for files are: \indextermunix{cp} for copying, \indextermunix{mv}
(short for `move') for renaming, and \indextermunix{rm} (`remove') for deleting.
...
Another useful command is \indextermunix{which}: it tells you what
...
\Level 1 {Shell environent variables}
\label{tut:shellvars}
...
\item Traditionally, \n{sed} could only function in a stream, so you
