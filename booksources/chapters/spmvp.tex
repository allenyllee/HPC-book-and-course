...
\begin{figure}
  \begin{quote}
    \includegraphics[scale=.12]{graphics/laplaceparallel}
  \end{quote}
...
\begin{figure}
  \includegraphics[scale=.25]{graphics/ghost}
...
If a processor has only a few neighbours, the above algorithm is wasteful. 
