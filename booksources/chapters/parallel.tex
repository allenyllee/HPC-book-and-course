...
We define the \indextermdef{critical path} as a (possibly non-unique) chain of dependencies
...
four-socket motherboard of the \indextermbus{TACC}{Ranger cluster}. Each chip has its
...
solutions such as IBM\index{IBM}'s \indexterm{token ring} network. It
...
\indextermbus{TACC}{Ranger cluster} at The
...
\index{Intel!Xeon Phi!Knight's Corner}
was a co-processor, though the second iteration, the
\emph{Knight's Landing}%
\index{Intel!Xeon Phi!Knight's Landing}
was self-hosted.
