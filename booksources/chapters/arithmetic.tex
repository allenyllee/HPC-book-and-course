...
The 754 standard also declares that a processor should be
...
\indextermsub{gradual}{underflow} may be controlled by libary
...
\item Certain applications, such as \indexterm{deep learning}, do not
  need full precision. The upcoming \indextermbus{Intel}{Knight's
    Mill} processes has \indexterm{half precision}, 16-bit floating
