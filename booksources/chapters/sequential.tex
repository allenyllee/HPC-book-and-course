...
are part of the \ac{CPU}\footnote {Direct-to-memory architectures are rare,
...
In a way, then, the modern \ac{CPU} looks to the programmer like a von
...
\acp{CPU}\footnote{Low level memory access can be controlled by the
