...
were obtained on the \indextermbus{AMD}{Opteron} processors of the
\indextermbus{TACC}{Ranger cluster}~\cite{tacc:ranger}.
...
%
\emph{matrix-matrix product}\index{matrix!matrix product!cache oblivious}
it improves on
...
\label{sec:mvp-opt}
\index{matrix!vector product!reuse analysis|(}
