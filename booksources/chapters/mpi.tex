...
MPI\footnote{This is not a course in MPI programming, and consequently
  ...
  instance~\cite{Gropp:UsingMPI1,Gropp:UsingMPI2,Gropp:UsingAdvancedMPI}.}. First of all, we no longer allocate
\begin{verbatim}
...
non-blocking collectives, neighbourhood collectives, and a profiling
