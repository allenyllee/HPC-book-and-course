...
\indexterm{Taylor series} expansion
\begin{footnoteenv}
...
\emph{Dirichlet boundary conditions}\index{Dirichlet boundary
  condition} which prescribe function values on the boundary of the
domain.}
\end{footnoteenv}
...
\begin{exercise}
  ...
  $x=0$ is known. This is known as a \indexterm{Neumann boundary
    condition}.
