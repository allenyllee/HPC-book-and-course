...
\begin{figure}[ht]
%  \includegraphics[scale=.6]{graphics/top500/types}
  \includegraphics[scale=.6]{graphics/top500/ChartByArchitecture}
...
\begin{figure}[ht]
  \includegraphics[scale=.6]{graphics/top500/processor}
  \caption{Evolution of the architecture types on the top500 list}
...
\begin{figure}[ht]
  \includegraphics[scale=.6]{graphics/top500/cores}
  \caption{Evolution of the architecture types on the top500 list}
