...
\def\lulurevision{4, October 2011}
...
\fancyfoot[RE]{\footnotesize\sl Introduction to High Performance
  Scientific Computing -- r\revision}
\begin{lulu}
\fancyfoot[RE]{\footnotesize\sl Introduction to High Performance
  Scientific Computing%\\release \lulurevision
}
\end{lulu}
...
\def\revdate{\escapechar-1\relax 1st edition 2011\ --\ \string\revision \revision}
\begin{lulu}
\def\publicdraft{}
\def\revdate{1st edition 2011}
\end{lulu}
...
\CHAPTER{Combinatorics}{combinatorics}
\begin{fmm}
...
\end{notready}
\APPENDIXac{Finite State Automatons}{FSA}{fsa}
