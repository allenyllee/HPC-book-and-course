\Level 0 {Mercurial or hg}
\index{mercurial|(}
\index{hg|see{mercurial}}

Mercurial is one of a new generation of \indextermsub{distributed}{source
code control} systems. Many of its commands are the same as for subversion,
...
The output of \n{hg log} is a list of all changesets so far. Used
as \n{hg log -r 5} or \n{hg log -r 6:8} it gives information on one or
more changesets.
