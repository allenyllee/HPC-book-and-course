...
\verbatiminput{tutorials-public/linking/fbind.F90}
\begin{verbatim}
%% ifort -c fbind.F90
%% nm fbind.o
.... T _s
...
\verbatiminput{tutorials-public/linking/fdata.F90}
...
\verbatiminput{tutorials-public/linking/fstring.F90}
and the C routine accepts a character string and its length:
\verbatiminput{tutorials-public/linking/cstring.c}
which produces:
\begin{verbatim}
length = 5
<<Word >>
