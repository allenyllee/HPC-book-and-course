{applications,approximation,discrete,namd,performance,programming}.tex\emph{Source code control}\index{source code control} systems, also
called \emph{revision control}\index{revision control
  systems|see{source code control}}  systems, are
...
will learn the basics of \indexterm{Subversion}, also called
\emph{svn}\index{svn|see{Subversion}}.

\Level 0 {How to do this tutorial}
\index{Subversion|(}
...
%% chmod g+rX ~
\end{verbatim}
To make a copy of the repository you specify a \n{file} URL:
\begin{verbatim}
...
\Level 0 {Shuffling files around}
