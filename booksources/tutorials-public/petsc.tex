{applications,approximation,discrete,namd,performance,programming}.tex\index{libraries!numerical|(}
...
\Level 0 {The Portable Extendable Toolkit for Scientific
  Computing}
...
\n{PetscInitialize}, \n{PetscFinalize}. Further more it uses two
routines:
\begin{itemize}
...
\listing{init.c}{tutorials-public/petsc/exercises-public/cexercises/init.c}
...
\listing{vec.c}{tutorials-public/petsc/exercises-public/cexercises/vec.c}
...
\listing{mat.c}{tutorials-public/petsc/exercises-public/cexercises/mat.c}
...
\Level 0 {Libraries for dense linear algebra: Lapack and Scalapack}

\index{linear algebra!software!dense|(}
\input tutorials-public/blas
\index{linear algebra!software!dense|)}
