program quiz
  ...
  ! 
  call MPI_ISEND(local_value,1,MPI_INTEGER,next_rank,tag1,MPI_COMM_WORLD,reqs(1),ierr)  
  call MPI_IRECV(prev_value ,1,MPI_INTEGER,prev_rank,tag1,MPI_COMM_WORLD,reqs(2),ierr)
  call MPI_ISEND(local_value,1,MPI_INTEGER,prev_rank,tag2,MPI_COMM_WORLD,reqs(3),ierr)  
  call MPI_IRECV(next_value ,1,MPI_INTEGER,next_rank,tag2,MPI_COMM_WORLD,reqs(4),ierr)
