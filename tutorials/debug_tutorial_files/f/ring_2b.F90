program quiz
  ...
  ! 
  call MPI_SENDRECV(local_value,1,MPI_INTEGER,next_rank,tag1, &
                    prev_value ,1,MPI_INTEGER,prev_rank,tag2,MPI_COMM_WORLD,stats(:,1),ierr)
  call MPI_SENDRECV(local_value,1,MPI_INTEGER,prev_rank,tag2, & 
                    next_value ,1,MPI_INTEGER,next_rank,tag1,MPI_COMM_WORLD,stats(:,2),ierr)
