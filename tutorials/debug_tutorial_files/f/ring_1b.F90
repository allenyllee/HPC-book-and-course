program quiz
  ...
  call MPI_RECV(local_value ,1,MPI_INTEGER,prev_rank,tag1,MPI_COMM_WORLD,stats(:,1),ierr)
  call MPI_SEND(local_value,1,MPI_INTEGER,prev_rank,tag2,MPI_COMM_WORLD,ierr)  
  call MPI_RECV(local_value ,1,MPI_INTEGER,next_rank,tag2,MPI_COMM_WORLD,stats(:,2),ierr)
