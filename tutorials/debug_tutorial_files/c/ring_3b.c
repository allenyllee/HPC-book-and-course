...
int main(int argc, char *argv[])  {
  ...
  //
  MPI_Isend(&local_value,0,MPI_INT,next_rank,tag1,MPI_COMM_WORLD,&reqs[0]);
  MPI_Irecv(&prev_value ,0,MPI_INT,prev_rank,tag1,MPI_COMM_WORLD,&reqs[1]);
  MPI_Isend(&local_value,0,MPI_INT,prev_rank,tag2,MPI_COMM_WORLD,&reqs[2]);
  MPI_Irecv(&next_value ,0,MPI_INT,next_rank,tag2,MPI_COMM_WORLD,&reqs[3]);
