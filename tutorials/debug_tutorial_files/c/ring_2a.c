...
int main(int argc, char *argv[])  {
  ...
  //
  MPI_Sendrecv(&local_value,1,MPI_INT,prev_rank,tag1,
               &prev_value ,1,MPI_INT,next_rank,tag1,MPI_COMM_WORLD,&stats[0]);
  MPI_Sendrecv(&local_value,1,MPI_INT,next_rank,tag2,
               &next_value ,1,MPI_INT,prev_rank,tag2,MPI_COMM_WORLD,&stats[1]);
