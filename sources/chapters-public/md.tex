...
\includegraphics[clip=true,viewport=70 70 362  362,scale=.5]{mdchapter/fig-nb-cellpdf}
} \qquad
\subfigure[Verlet neighbor list method.]{
\includegraphics[clip=true,viewport=70 70 362  362,scale=.5]{mdchapter/fig-nb-verletpdf}
}
...
\subsubsection*{Using Cell and Neighbor Lists Together}  
...
\section{Parallel Decompositions}
...
\begin{figure}[htbp]
\begin{center}
\subfigure[Decomposition into 64 cells.]{\includegraphics[clip=true,viewport=70 70 506 506,scale=.40]{mdchapter/fig-spatial1pdf}} \qquad
\subfigure[Import region for one cell.]{\includegraphics[clip=true,viewport=70 70 506 506,scale=.40]{mdchapter/fig-spatial2pdf}}
...
\section{Parallel Fast Fourier Transform}
\label{sec:fft}
...
\begin{figure}[htb]
\begin{center}
\subfigure[Data flow diagram (shown without horizontal lines for clarity) for 1-D FFT for 16 points.]{\includegraphics[clip=true,viewport=144 85 648 522,scale=.5]{mdchapter/fig-fft-secondpdf}} \quad
\subfigure[Partitioning of the indices before (left) and after (right) the transpose.]{\includegraphics[clip=true,viewport=100 190 436 360,scale=.3]{mdchapter/fig-fft-thirdpdf}}
...
\begin{figure}[htbp]
\begin{center}
\subfigure[Block Decomposition]{\includegraphics[clip=true,viewport=100 300 330 490,scale=.6]{mdchapter/fig-fft1pdf}}% \quad
\subfigure[Slab Decomposition]{\includegraphics[clip=true,viewport=100 300 330 490,scale=.6]{mdchapter/fig-fft2pdf}}% \quad
\subfigure[Pencil Decomposition]{\includegraphics[clip=true,viewport=100 300 330 490,scale=.6]{mdchapter/fig-fft3pdf}}
