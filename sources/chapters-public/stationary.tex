...
\end{tabbing}
  \end{quote}
The scheme we have given here is called \indexterm{stationary iteration},
...
The congence criterium $|\lambda(I-AK\inv)|<1$ (see
...
\item Iterative refinement\index{iterative refinement}: $K=LU$ where
