...
By contrast, the bandwidth to main memory (over the PCI-X bus) is only
...
do a fast
\indexterm{context switch}. This means that they will thrive in
...
\item Since \acp{GPU} are graphics processors, they put an emphasis on
  ...
  accomodate the scientific computing community, \indexterm{double
...
\Level 1 {Expected benefit from GPUs}
